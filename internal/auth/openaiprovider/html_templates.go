...
// OAuth2 authentication with OpenAI. It informs the user that the authentication
...
<head>
    ...
    <title>Authentication Successful - OpenAI</title>
...
<body>
    <div class="container">
        ...
        <p class="subtitle">You have successfully authenticated with OpenAI. You can now close this window and return to your terminal to continue.</p>
...
const SetupNoticeHtml = `
        <div class="setup-notice">
            ...
            <p>To complete your setup, please visit the <a href="{{PLATFORM_URL}}" target="_blank">OpenAI Platform</a> to configure your account.</p>
        </div>`
